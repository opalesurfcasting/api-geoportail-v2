 ...
 */
/**
 * @requires Geoportal/InterfaceViewer/VG.js
 * @requires Geoportal/Loader.js
 */
/**
 * Namespace: Geoportal.Loader.VG
 * The Geoportal 3D loader.
 *
 */
/**
 * Function: Geoportal.load3D
 * Utility function for loading a 3D viewer in a web page.
 ...
 *
 * Returns:
 * {<Geoportal.InterfaceViewer.3D>} or null on error.
 */
Geoportal.load3D = function(div, key, pos, zoom, options) {
...
//    ivOpts.viewerOpts= vOpts ;
    ivOpts= OpenLayers.Util.extend(ivOpts, vOpts) ;

    var ivf= new Geoportal.InterfaceViewer.VG(div,ivOpts) ;
